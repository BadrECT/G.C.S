...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?php echo URLROOT; ?>/admin/editTraining/<?php echo $data['id']; ?>" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="datetime-local" name="date_heure" class="form-control form-control-lg <?php echo (!empty($data['date_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo date('Y-m-d\TH:i', strtotime($data['date_heure'])); ?>">
