...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?php echo URLROOT; ?>/admin/addPayment" method="post">
                <div class="form-group mb-3">
                    <label>Membre Concerné: <sup>*</sup></label>
                    <select name="membre_id" class="form-control form-control-lg">
                        <?php foreach($data['members'] as $member) : ?>
                            <option value="<?php echo $member->userId; ?>"><?php echo $member->name; ?> (<?php echo $member->email; ?>)</option>
                        <?php endforeach; ?>
                    </select>
                </div>

                <div class="form-group mb-3">
                     <label>Motif (ex: Cotisation 2024): <sup>*</sup></label>
                 ...
                 <div class="form-group mb-3">
                    ...
                    <input type="datetime-local" name="date_paiement" class="form-control form-control-lg" value="<?php echo $data['date_paiement']; ?>">
                </div>
                ...
                <input type="submit" class="btn btn-success" value="Enregistrer le paiement">
            </form>
        </div>
    </div>
</div>
